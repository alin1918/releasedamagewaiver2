 ...
 */
namespace SalesIgniter\DamageWaiver\Block\Checkout;
...
class AttributeMerger
{
     ...
     * @return array
     */
    public function merge($elements, $dataScopePrefix, array $fields = [])
    {
    ...
    protected function getFieldConfig(
        ...
        if ($attributeConfig['formElement'] == 'multiline') {
            return $this->getMultilineFieldConfig($attributeCode, $attributeConfig, $dataScopePrefix);
        }
     ...
     * @return array
     */
    protected function getMultilineFieldConfig($attributeCode, array $attributeConfig, $dataScopePrefix)
    {
        $lines = [];
